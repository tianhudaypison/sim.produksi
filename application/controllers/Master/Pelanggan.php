...
class Pelanggan extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->pagePath = 'Master/Pelanggan/';
        $this->load->library('form_validation');
        $this->form_validation->set_error_delimiters('<text>', '</text>');
        $this->breadcrum = array(
          array('Master', '#'),
          array('Pelanggan', $this->pagePath),
        );

        // CallModel
        $this->load->model('Master/PelangganModel', 'model');
    }
    ...
    {
        $this->form_validation->set_rules('nama', 'Nama Pelanggan', 'trim|required|min_length[1]');
