...
class TipeKemeja extends CI_Controller
{
    protected $pagePath;
    protected $breadcrum;
    ...
    public function __construct()
    {
        ...
        $this->pagePath = 'Master/TipeKemeja/';
        $this->load->library('form_validation');
        $this->form_validation->set_error_delimiters('<text>', '</text>');
        $this->breadcrum = array(
          array('Master', '#'),
          array('TipeKemeja', $this->pagePath),
        );

        // CallModel
        $this->load->model('Master/TipeKemejaModel', 'model');
    }

    public function index()
    {
        $data = array();
        $data['title'] = 'TipeKemeja';
    ...
    {
        $this->form_validation->set_rules('nama', 'Nama TipeKemeja', 'trim|required|min_length[1]');
