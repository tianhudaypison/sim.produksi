...
class Bahan extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->pagePath = 'Master/Bahan/';
        $this->load->library('form_validation');
        $this->form_validation->set_error_delimiters('<text>', '</text>');
        $this->breadcrum = array(
          array('Master', '#'),
          array('Bahan Baku', $this->pagePath),
        );

        // CallModel
        $this->load->model('Master/BahanModel', 'model');
    }
    ...
    {
        $this->form_validation->set_rules('nama', 'Nama Bahan', 'trim|required|min_length[1]');
