...
class Pegawai extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->pagePath = 'Master/Pegawai/';
        $this->load->library('form_validation');
        $this->form_validation->set_error_delimiters('<text>', '</text>');
        $this->breadcrum = array(
          array('Master', '#'),
          array('Pegawai', $this->pagePath),
        );

        // CallModel
        $this->load->model('Master/PegawaiModel', 'model');
    }
    ...
    {
        $this->form_validation->set_rules('nama', 'Nama Pegawai', 'trim|required|min_length[1]');
