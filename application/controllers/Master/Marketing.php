...
class Marketing extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->pagePath = 'Master/Marketing/';
        $this->load->library('form_validation');
        $this->form_validation->set_error_delimiters('<text>', '</text>');
        $this->breadcrum = array(
          array('Master', '#'),
          array('Marketing', $this->pagePath),
        );

        // CallModel
        $this->load->model('Master/MarketingModel', 'model');
    }
    ...
    {
        $this->form_validation->set_rules('nama', 'Nama Marketing', 'trim|required|min_length[1]');
