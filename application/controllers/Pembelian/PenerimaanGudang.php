...
class PenerimaanGudang extends CI_Controller
{
    protected $pagePath;
    protected $breadcrum;
    ...
    public function __construct()
    {
        ...
        $this->pagePath = 'Pembelian/PenerimaanGudang/';
        $this->load->library('form_validation');
        $this->form_validation->set_error_delimiters('<text>', '</text>');
        $this->breadcrum = array(
          array('Pembelian', '#'),
          array('Penerimaan Gudang', $this->pagePath),
        );

        // CallModel
        $this->load->model('Pembelian/PenerimaanGudangModel', 'model');
    }
