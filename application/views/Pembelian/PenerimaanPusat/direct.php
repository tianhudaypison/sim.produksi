<div class="row">
  <div class="col-12">
    <form id="form" class="form-horizontal" action="<?= $loader['path'] ?>saveDirect" method="POST" role="form">
      <div class="card-box">
          <div class="row">
              <div class="col-12">
                  <div class="p-20">
                      ...
                      <div class="form-group row">
                          <label class="col-2 col-form-label">No. Pemesanan</label>
                          <div class="col-10">
                            <input type="text" class="form-control" value="{nopemesanan}" disabled>
                          </div>
                      </div>
                      <div class="form-group row">
                          <label class="col-2 col-form-label">No. DO (Rekanan)</label>
                          <div class="col-10">
                            <input type="text" class="form-control" value="{nodo}" disabled>
                          </div>
                      </div>
                      <div class="form-group row">
                          <label class="col-2 col-form-label">Gudang</label>
                          <div class="col-10">
                            <select id="idGudang" name="idgudang" class="form-control select2">
                              <option value="0" selected disabled>Pilih Opsi</option>
          ...
          <input type="hidden" name="idpenerimaan" value="{id}">
          <input type="hidden" name="idrekanan" value="{idrekanan}">
          ...
          <div class="col-12">
            <table id="produkList" class="tablesaw m-t-20 table m-b-0 tablesaw-stack" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <tbody>
                  ...
                  <td><a href="javascript: void(0);" class="btn btn-outline-primary waves-effect produkEdit" data-idprodukkemasan="<?= $row->idprodukkemasan ?>" data-kuantitasmax="<?= $row->kuantitas ?>" data-stbonus="<?= $row->stbonus ?>" data-toggle="modal" data-target="#modalDetailPerProduct"><i class="fa fa-pencil"></i> Ubah</a></td>
                  <? endforeach; ?>
                </tbody>
            </table>
          </div>
