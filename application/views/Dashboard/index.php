        ...
        <div class="card-box">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-centered m-0">
                    ...
                    <tr>
                        <td>
                            <img src="{assets_path}images/users/avatar-2.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                        </td>
                    ...
                    <tr>
                        <td>
                            <img src="{assets_path}images/users/avatar-3.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                        </td>
                    ...
                    <tr>
                        <td>
                            <img src="{assets_path}images/users/avatar-4.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                        </td>
                    ...
                    <tr>
                        <td>
                            <img src="{assets_path}images/users/avatar-5.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                        </td>
                    ...
                    <tr>
                        <td>
                            <img src="{assets_path}images/users/avatar-6.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                        </td>
